...
if (GCOVR AND (NOT MSVC))
    ...
    if(GCOVR_EXEC)
        ...
        add_custom_command(TARGET run_coverage COMMAND echo && echo "-- Gcovr:" && "${GCOVR_EXEC}" -r "${PROJECT_SOURCE_DIR}" "${CMAKE_BINARY_DIR}" && "${GCOVR_EXEC}" -r "${PROJECT_SOURCE_DIR}" "${CMAKE_BINARY_DIR}" --html --html-details -o "${CMAKE_BINARY_DIR}/gcovr/index.html" && echo "HTML Summary: file://${url_root_path}/gcovr/index.html")
    else()
